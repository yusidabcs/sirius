...
/**
 * menu_register_cache class.
 * 
 * menu_register_cache is the access to the menu_register_obj which is the actual object.
 * it is cached because it does not change a lot
 */
class menu_register_cache extends \core\app\classes\cacheable\cacheable {
    
    protected $cache_name = 'menuRegister'; //need to define the name of the cache
    ...
    {
        $this->cache = new menu_register_obj;
        return;
    }
