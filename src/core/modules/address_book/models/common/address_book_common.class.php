...
/**
 * Final address_book_common class.
 * 
 * @final
 *
 * is a singleton
...
final class address_book_common {
	
	private static $_singleton;
    private static $_address_book_common_obj; // the actual class object for the menu register
	...
	public static function getInstance()
	{
		...
		{
			self::$_singleton = new address_book_common();
		}
		return self::$_address_book_common_obj;
	}
    ...
    private function _loadViewObj()
    {
        try 
        {
            self::$_address_book_common_obj = new address_book_common_obj();
        } catch (\Exception $e) {
