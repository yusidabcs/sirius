...
<div id="stcw" class="tab-pane fade in" role="tabpanel">
    ...
    <div class="card card-cascade mb-4">
        ...
        <div class="card-body card-body-cascade">
            ...
            <table class="table table-responsive-md" id="stwc_table">
                <thead>
                <tr>
                <th width="5%">&nbsp;</th>
                ...
                <tbody>
                <?php
                $stcwDocuments = array_map(function($item) {
                    if ($item['level'] === 'stcw') {
                        return $item;
                    }
                }, $educationList);
							foreach($stcwDocuments as $education_id => $education)
							{
                                if(!empty($education)){
?>				
								<tr class="<?php echo $education['tr_status']; ?>" style="background-color: <?php echo ($education['status'] == 'accepted') ? 'rgba(67, 230, 99, 0.38)':'rgba(230, 44, 44, 0.38)'; ?>">
									...
									<td><?php echo $education['status']; ?></td>
...
?>
										...
										<!-- preview -->
										<a data-toggle="modal" data-target="#stcwModal_<?php echo $education_id; ?>" href="#"><i class="far fa-file-alt text-primary" title="<?php echo $term_icon_preview; ?>"></i></a>
										
										<!-- preview modal -->	
										<div class="modal fade" id="stcwModal_<?php echo $education_id; ?>" tabindex="-1" role="dialog" aria-labelledby="educationModal_<?php echo $education_id; ?>" aria-hidden="true">
...
?>	
														...
														<?php if($_SESSION['user_group'] === 'ADMIN' && $education['status'] !== 'accepted'): ?>
															<div class="d-flex justify-content-center">
																<a href="#" data-education-id="<?php echo $education_id ?>" data-address-book-id="<?php echo $_SESSION['personal']['address_book_id'] ?>" class="btn btn-primary mr-2 confirm-stcw">Confirm</a>
																<a href="#" data-education-id="<?php echo $education_id ?>" data-address-book-id="<?php echo $_SESSION['personal']['address_book_id'] ?>" class="btn btn-danger reject-stcw">Reject</a>
															</div>
														<?php endif; ?>
													</div>
												</div>
