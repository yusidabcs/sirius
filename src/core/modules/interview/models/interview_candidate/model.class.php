<?php
namespace core\modules\interview\models\interview_candidate;


final class model extends \core\app\classes\module_base\module_model {

	protected $model_name = 'interview_candidate';
	...
	{
		$this->view_variables_obj->setViewTemplate('interview_candidate');
		return;
	}
