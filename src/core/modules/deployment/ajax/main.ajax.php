<?php
namespace core\modules\deployment\ajax;
...
final class main extends \core\app\classes\module_base\module_ajax {
	...
	{	
		...
		$this->deployment_db = new \core\modules\deployment\models\common\common();
		switch($this->option) 
		{	
			case 'list':
			...
			case 'update-deployment':
				...
				$db->updateDeploymentStatus($_POST['address_book_id'], $_POST['deployment_status']);
				
				$out = array(
					'message' => 'Deployment status has been updated',
					'status' => 'success'
				);
