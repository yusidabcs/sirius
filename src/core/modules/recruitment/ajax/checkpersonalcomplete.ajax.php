 ...
 */
final class checkpersonalcomplete extends \core\app\classes\module_base\module_ajax {
    ...
    public function run()
    {
		...
		$personal_complete = $this->_checkVerified($this->option);
		$data = [
			'personal_complete' => $personal_complete,
			'address_book_id' => $this->option,
			'message' => !$personal_complete ? 'Candidate personal data not complete yet, please upload personal data before process to verified.':''
		];
