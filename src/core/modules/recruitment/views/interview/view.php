                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body table-responsive">
                        ...
                        <table class="table table-sm ">
                            ...
                            <tr>
                                <td colspan="2">
                                    <h5>Online Application Detail</h5>
                                <table class="table">
                                    <tr>
                                    ...
                                    <tr>
                                        <td>Online Application <strong>accessed</strong> by candidate confirmed: </td>
                                        <td id="ctrack_accessed_on"></td>
                                    </tr>
                                    <tr>
                                        <td>Candidate <strong>completed</strong> initial Online Application: </td>
                ...
                <div class="modal-body " id="pre-screen-modal-body">
                    ...
                    <div class="p-3">
                        ...
                        <div class="form-check form-check-inline">
                            <input type="radio" class="form-check-input" id="type_physical" name="type" value="physical" checked>
                            <label class="form-check-label" for="type_physical">Physical Interview</label>
                        </div>

                        <div class="form-check form-check-inline">
                            <input type="radio" class="form-check-input" id="type_online" name="type" value="online">
                            <label class="form-check-label" for="type_online">Online Interview</label>
                        </div>

                    </div>
                    <div id="physical_interview">
                        <label for="interview_location_id">Select Schedule</label>
                        <select id="interview_location_id" class="form-control" required>
                        </select>
                    </div>

                    <div id="online_interview" class="not-showing">
                        <div class="md-form">
