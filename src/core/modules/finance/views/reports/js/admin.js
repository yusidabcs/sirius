$(document).ready(function () {
    ...
    $('#interview_security_form').on('submit', function () {
        ...
        $.ajax({
            url: '/ajax/finance/reports/insert',
            data: $(this).serialize(),
            type: 'POST',
            datatype : 'json',
            success: function(rs) {
    ...
    $('body').on('keyup','#search_ab',function()
    {
        ...
        timer_search_ab = setTimeout(function()
        {
            ...
            xhr = $.post('/ajax/address_book/searchaddressbooks/finance_reports/'+searchString, {type: 'per'})
    ...
    $('body').on('click','.btn-delete', function () {
        ...
        Swal.fire({
            ...
            if(result.value)
                $.ajax({
                    url: '/ajax/finance/reports/delete/'+data.address_book_id,
                    data: data,
                    type: 'POST',
                    datatype : 'json',
                    success: function(rs) {
