...
final class security_checker extends \core\app\classes\module_base\module_ajax{
    ...
    public function run()
    {
        if ($this->option)
        {
            ...
            if ( $type == 'insert' )
            {
                ...
                $rs = $this->security_checker_db->insertInterviewSecurity($data);
                if($rs > 0){
            ...
            else if ( $type == 'delete' )
            {
                ...
                $rs = $this->security_checker_db->deleteInterviewSecurity($data);
                if($rs > 0){
                    return $this->response([
                ...
                $result = $this->security_checker_db->getInterviewSecurityDatatable();
