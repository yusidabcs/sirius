...
final class psf extends \core\app\classes\module_base\module_ajax {
    ...
    {
        $out = null;
        $this->finance_db = new \core\modules\workflow\models\common\psf_tracker_db();
        switch($this->option)
        {
            case 'list':

                $out = $this->finance_db->getPSFDatatable();
            ...
            case 'generate_invoice':
                ...
                $rs = $this->finance_db->updatePsfGenerateInvoice($data);
                if ($rs > 0) {
            ...
            case 'pay_invoice':
                ...
                $rs = $this->finance_db->updatePsfPayInvoice($data);
                if ($rs > 0) {
