<?php
namespace core\modules\workflow\models\personal_reference;
...
final class model extends \core\app\classes\module_base\module_model {
	...
	protected $model_name = 'personal_reference';
	...
	{
		$this->view_variables_obj->setViewTemplate('personal_reference');
		return;
	}
