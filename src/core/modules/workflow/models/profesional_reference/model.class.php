<?php
namespace core\modules\workflow\models\profesional_reference;
...
final class model extends \core\app\classes\module_base\module_model {
	...
	protected $model_name = 'profesional_reference';
	...
	{
		$this->authorize();
        $this->status = ['request','confirmation','review','accepted','rejected'];
	...
	{
		$this->view_variables_obj->setViewTemplate('profesional_reference');
		return;
	}
