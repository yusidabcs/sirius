<?php
namespace core\modules\workflow\models\visa;
...
final class model extends \core\app\classes\module_base\module_model {
	...
	{
		$this->authorize();
        $this->status = ['register_visa','docs_application', 'docs_application_rejected','interview','upload_visa', 'accepted', 'rejected', 'not_active'];
