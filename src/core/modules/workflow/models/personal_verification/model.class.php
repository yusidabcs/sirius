<?php
namespace core\modules\workflow\models\personal_verification;
...
final class model extends \core\app\classes\module_base\module_model {
	...
	protected $model_name = 'personal_verification';
	...
	{
		$this->authorize();
        $this->status = ['request_verification','accepted','rejected'];
	...
	{
		$this->view_variables_obj->setViewTemplate('personal_verification');
		return;
	}
