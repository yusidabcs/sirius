<?php
namespace core\modules\workflow\models\bgc;
...
final class model extends \core\app\classes\module_base\module_model {
	...
	{
		$this->authorize();
        $this->status = ['pending','send_notification', 'confirmed','accepted','rejected'];
	...
	{
		$this->view_variables_obj->setViewTemplate('bgc');
		return;
	}
