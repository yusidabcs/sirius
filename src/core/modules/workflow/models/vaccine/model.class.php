<?php
namespace core\modules\workflow\models\vaccine;
...
final class model extends \core\app\classes\module_base\module_model {
	...
	{
		$this->authorize();
        $this->status = ['request_file','request_appointment_date', 'review_file','accepted','rejected'];
	...
	{
		$this->view_variables_obj->setViewTemplate('vaccine');
		return;
	}
