$(document).ready(function () {
    ...
    const table = $('#list_flight').DataTable({
            "processing": true,
            "serverSide": true,
            'responsive': true,
            "ajax": {
    ...
    $(document).on('click', '.btn-review-file', function(e) {
        ...
        $.get('/ajax/workflow/flight/file-preview/'+data.address_book_id, function(response) {
            Swal.close();
            $('#flight_number').html(response.flight_number);
            $('#departure_date').html(response.departure_date);

            $('.confirm-flight, .reject-flight').attr('data-flight-id', response.flight_number);
    ...
    $(document).on('click','.btn-request-file', function (e) {
        e.preventDefault();
    ...
    $('.confirm-flight').click(function(e)
		{
            e.preventDefault();
			Swal.fire({
				title: 'Are you sure?',
		...
		$('.reject-flight').click(function(e)
		{
            e.preventDefault();
			Swal.fire({
				title: 'Are you sure?',
