<div class="container">
    <div class="card">
        ...
        <div class="card-body w-auto">
            ...
            <table class="table" id="list_visa">
                <thead>
                <tr>
                    <th>Name</th>
                    <th>Status</th>
...
<div class="modal fade" id="visaModal" role="dialog" aria-labelledby="educationModal" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="d-flex justify-content-center">
                    <a href="#" data-visa-id="" class="btn btn-primary mr-2 confirm-visa">Confirm</a>
                    <a href="#" data-visa-id="" class="btn btn-danger reject-visa">Reject</a>
                </div>
            </div>
        </div>
    </div>
