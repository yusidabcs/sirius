<div class="container">
    <div class="card">
        ...
        <div class="card-body w-auto">
            ...
            <table class="table" id="list_vaccine">
                <thead>
                <tr>
                    <th>Name</th>
                    <th>Vaccine Type</th>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="d-flex justify-content-center">
                    <a href="#" data-vaccine-id="" class="btn btn-primary mr-2 confirm-vaccine">Confirm</a>
                    <a href="#" data-vaccine-id="" class="btn btn-danger reject-vaccine">Reject</a>
                </div>
            </div>
        </div>
    </div>
