...
final class common {
    ...
    private static $_common_obj; // the actual class object for the menu register
	...
	public static function getInstance()
	{
		...
		{
			self::$_singleton = new common();
		}
		return self::$_common_obj;
	}
     
    private function _loadViewObj()
    {
        self::$_common_obj = new common_obj();
		return;
    }
